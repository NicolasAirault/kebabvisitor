...
public class KebabTest {
	...
	public void setUp() {
		...
		kebabBoeuf = new Salade("laitue", new Tomate("tomate rouge",
				new Oignon("oignon rouge", new Boeuf("boeuf", new Pain("pita", new Assiette())))));
	...
	public void un_kebab_contient_bien_les_noms_de_tous_les_ingredients_ajoutes() {
		...
		assertThat(kebabBoeuf.getIngredients()).extracting("nom").containsExactly("pita", "boeuf", "oignon rouge",
				"tomate rouge", "laitue");
	}
